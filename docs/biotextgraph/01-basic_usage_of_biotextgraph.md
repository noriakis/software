...
#>  [1] ggrepel_0.9.3         ggkegg_0.99.0        
#>  [3] XML_3.99-0.13         tidygraph_1.2.3      
#>  [5] ggfx_1.0.1            igraph_1.4.1         
#>  [7] GetoptLong_1.0.5      ggforce_0.4.1        
#>  [9] concaveman_1.1.0      dplyr_1.1.0          
#> [11] dendextend_1.16.0     clusterProfiler_4.6.2
#> [13] ReactomePA_1.42.0     RColorBrewer_1.1-3   
#> [15] ggraph_2.1.0.9000     org.Hs.eg.db_3.16.0  
#> [17] AnnotationDbi_1.60.0  IRanges_2.32.0       
...
#>  [15] colorspace_2.1-0       GOSemSim_2.24.0       
#>  [17] filelock_1.0.2         NLP_0.2-1             
#>  [19] highr_0.10             knitr_1.42            
#>  [21] rstudioapi_0.14        DOSE_3.24.2           
...
#> [113] parallel_4.2.2         pkgconfig_2.0.3       
#> [115] xml2_1.3.3             ggtree_3.6.2          
#> [117] bslib_0.4.2            XVector_0.38.0        
#> [119] yulab.utils_0.0.6      stringr_1.5.0         
#> [121] callr_3.7.3            digest_0.6.31         
#> [123] showtextdb_3.0         graph_1.76.0          
#> [125] Biostrings_2.66.0      tm_0.7-11             
#> [127] rmarkdown_2.20         fastmatch_1.1-3       
#> [129] tidytree_0.4.2         cyjShiny_1.0.34       
#> [131] curl_5.0.0             shiny_1.7.4           
#> [133] graphite_1.44.0        rjson_0.2.21          
#> [135] lifecycle_1.0.3        nlme_3.1-161          
#> [137] jsonlite_1.8.4         desc_1.4.2            
#> [139] viridisLite_0.4.1      fansi_1.0.4           
#> [141] pillar_1.8.1           lattice_0.20-45       
#> [143] KEGGREST_1.38.0        fastmap_1.1.1         
#> [145] httr_1.4.5             pkgbuild_1.4.0        
#> [147] GO.db_3.16.0           remotes_2.4.2         
#> [149] glue_1.6.2             png_0.1-8             
#> [151] bit_4.0.5              profvis_0.3.7         
#> [153] stringi_1.7.12         sass_0.4.5            
#> [155] blob_1.2.3             textshaping_0.3.6     
#> [157] memoise_2.0.1          ape_5.7               
#> [159] sysfonts_0.8.8
```
