...
#> Query: 
#> Graph: V(20), E(72)
#> Degree: addition(12)/cluster(12)/Escherichia(11)/gene(10)/Biosynthesis(9)
#> 616.5 Kb
metanet@net
```
...
#> Query: 
#> Graph: V(48), E(98)
#> Degree: Escherichia coli(24)/addition(12)/cluster(12)/Escherichia(11)/gene(10)
#> 634.3 Kb
metanet2@net
```
...
#> [16] tools_4.2.1     xfun_0.37       yaml_2.3.7     
