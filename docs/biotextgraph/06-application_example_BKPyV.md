...
gnc
#> 
#>     SESN1     RAD17     DYRK2       FAS      TSC1      DDB2 
#>        11        10         6         6         6         5 
#>  DYNC2LI1    LZTFL1      MDM2 TNFRSF10B      BTG1     CCNG2 
#>         5         5         5         5         4         4 
#>    CHMP4C   GADD45A       OGT     SESN3      SGK1     BIRC2 
#>         4         4         4         4         4         3 
#>     EXOC1     IFT74 TNFRSF10D     WDR19     CFLAR      PLK2 
#>         3         3         3         3         2         2 
#>    PPP2CB     RRM2B      BTG2 
#>         2         2         1
...
top <- names(gnc[gnc>=5])
top
#>  [1] "SESN1"     "RAD17"     "DYRK2"     "FAS"      
#>  [5] "TSC1"      "DDB2"      "DYNC2LI1"  "LZTFL1"   
#>  [9] "MDM2"      "TNFRSF10B"
```
...
#>  [28] downlit_0.4.3                
#>  [29] RCurl_1.98-1.12              
#>  [30] yulab.utils_0.1.0            
#>  [31] tweenr_2.0.2                 
#>  [32] rappdirs_0.3.3               
#>  [33] pvclust_2.2-0                
#>  [34] GenomeInfoDbData_1.2.10      
#>  [35] ISOcodes_2022.09.29          
#>  [36] enrichplot_1.21.3            
#>  [37] cyjShiny_1.0.42              
#>  [38] tm_0.7-11                    
#>  [39] ggrepel_0.9.3                
#>  [40] tidytree_0.4.5               
#>  [41] rentrez_1.2.3                
#>  [42] reactome.db_1.86.0           
#>  [43] svglite_2.1.1                
#>  [44] codetools_0.2-19             
#>  [45] DOSE_3.27.2                  
#>  [46] xml2_1.3.5                   
...
#> [110] curl_5.0.2                   
#> [111] cachem_1.0.8                 
#> [112] GlobalOptions_0.1.2          
#> [113] stringr_1.5.0                
#> [114] BiocVersion_3.18.0           
#> [115] parallel_4.3.1               
#> [116] HDO.db_0.99.1                
#> [117] concaveman_1.1.0             
#> [118] pillar_1.9.0                 
#> [119] grid_4.3.1                   
#> [120] vctrs_0.6.3                  
#> [121] slam_0.1-50                  
...
#> [129] crayon_1.5.2                 
#> [130] labeling_0.4.3               
#> [131] graphhighlight_0.1.0         
#> [132] plyr_1.8.8                   
#> [133] fs_1.6.3                     
#> [134] stringi_1.7.12               
#> [135] viridisLite_0.4.2            
#> [136] BiocParallel_1.35.4          
#> [137] MPO.db_0.99.7                
#> [138] munsell_0.5.0                
#> [139] Biostrings_2.69.2            
#> [140] lazyeval_0.2.2               
#> [141] GOSemSim_2.27.3              
#> [142] Matrix_1.6-3                 
#> [143] patchwork_1.1.3              
...
#> [146] shiny_1.7.5                  
#> [147] highr_0.10                   
#> [148] interactiveDisplayBase_1.39.0
#> [149] AnnotationHub_3.9.2          
#> [150] memoise_2.0.1                
#> [151] bslib_0.5.1                  
#> [152] ggtree_3.9.1                 
#> [153] fastmatch_1.1-4              
