...
#> 
#> $test$GRAPH
#> IGRAPH b2226d4 UN-- 4 2 -- 
#> + attr: name (v/c)
#> + edges from b2226d4 (vertex names):
...
#> # ℹ 4,277 more rows
#> $graph
#> IGRAPH b49b395 UN-- 21 922 -- 
#> + attr: name (v/c), category (v/c), size (v/n)
#> + edges from b49b395 (vertex names):
