...
#> 
#> $test$GRAPH
#> IGRAPH ebb3c78 UN-- 4 2 -- 
#> + attr: name (v/c)
#> + edges from ebb3c78 (vertex names):
...
#> # ℹ 4,277 more rows
#> $graph
#> IGRAPH ed0c7b9 UN-- 21 922 -- 
#> + attr: name (v/c), category (v/c), size (v/n)
#> + edges from ed0c7b9 (vertex names):
