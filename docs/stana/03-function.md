...
#> 
#> $test$GRAPH
#> IGRAPH 0912da6 UN-- 4 2 -- 
#> + attr: name (v/c)
#> + edges from 0912da6 (vertex names):
...
#> # ℹ 4,277 more rows
#> $graph
#> IGRAPH 0a3a6c0 UN-- 21 922 -- 
#> + attr: name (v/c), category (v/c), size (v/n)
#> + edges from 0a3a6c0 (vertex names):
