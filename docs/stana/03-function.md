...
#> 
#> $test$GRAPH
#> IGRAPH 6a2e1c0 UN-- 4 2 -- 
#> + attr: name (v/c)
#> + edges from 6a2e1c0 (vertex names):
...
#> # ℹ 4,277 more rows
#> $graph
#> IGRAPH 6bacaf2 UN-- 21 922 -- 
#> + attr: name (v/c), category (v/c), size (v/n)
#> + edges from 6bacaf2 (vertex names):
