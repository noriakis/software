...
#>  [69] yaml_2.3.6             memoise_2.0.1         
#>  [71] gridExtra_2.3          yulab.utils_0.0.6     
#>  [73] sass_0.4.4             stringi_1.7.12        
#>  [75] RSQLite_2.2.20         highr_0.10            
#>  [77] S4Vectors_0.36.1       BiocGenerics_0.44.0   
#>  [79] GenomeInfoDb_1.34.6    rlang_1.0.6           
#>  [81] pkgconfig_2.0.3        bitops_1.0-7          
#>  [83] evaluate_0.19          purrr_1.0.1           
#>  [85] labeling_0.4.2         patchwork_1.1.2       
#>  [87] htmlwidgets_1.6.1      cowplot_1.1.1         
#>  [89] bit_4.0.5              tidyselect_1.2.0      
#>  [91] magrittr_2.0.3         bookdown_0.31         
#>  [93] R6_2.5.1               IRanges_2.32.0        
#>  [95] generics_0.1.3         DBI_1.1.3             
#>  [97] pillar_1.8.1           withr_2.5.0           
#>  [99] KEGGREST_1.38.0        RCurl_1.98-1.9        
#> [101] tibble_3.1.8           crayon_1.5.2          
#> [103] wordcloud_2.6          utf8_1.2.2            
#> [105] rmarkdown_2.19         viridis_0.6.2         
#> [107] GetoptLong_1.0.5       grid_4.2.2            
#> [109] blob_1.2.3             digest_0.6.31         
#> [111] xtable_1.8-4           tm_0.7-10             
#> [113] tidyr_1.2.1            httpuv_1.6.8          
#> [115] gridGraphics_0.5-1     stats4_4.2.2          
#> [117] munsell_0.5.0          ggplotify_0.1.0       
#> [119] viridisLite_0.4.1      bslib_0.4.2
```
