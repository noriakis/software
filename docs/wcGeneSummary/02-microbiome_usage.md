...
#>  [71] RSQLite_2.2.15         S4Vectors_0.34.0      
#>  [73] BiocGenerics_0.42.0    GenomeInfoDb_1.32.2   
#>  [75] rlang_1.0.6            pkgconfig_2.0.3       
#>  [77] bitops_1.0-7           evaluate_0.15         
#>  [79] purrr_0.3.4            patchwork_1.1.1       
#>  [81] htmlwidgets_1.5.4      cowplot_1.1.1         
#>  [83] bit_4.0.4              tidyselect_1.2.0      
#>  [85] magrittr_2.0.3         bookdown_0.29         
#>  [87] R6_2.5.1               IRanges_2.30.0        
#>  [89] generics_0.1.3         DBI_1.1.3             
#>  [91] pillar_1.8.0           withr_2.5.0           
#>  [93] KEGGREST_1.36.3        RCurl_1.98-1.7        
#>  [95] tibble_3.1.7           crayon_1.5.1          
#>  [97] wordcloud_2.6          utf8_1.2.2            
#>  [99] rmarkdown_2.14         viridis_0.6.2         
#> [101] GetoptLong_1.0.5       grid_4.2.1            
#> [103] blob_1.2.3             digest_0.6.29         
#> [105] xtable_1.8-4           tm_0.7-8              
#> [107] tidyr_1.2.0            httpuv_1.6.5          
#> [109] gridGraphics_0.5-1     stats4_4.2.1          
#> [111] munsell_0.5.0          ggplotify_0.1.0       
#> [113] viridisLite_0.4.0      bslib_0.4.0
```
