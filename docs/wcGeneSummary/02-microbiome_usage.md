...
#>  [43] dplyr_1.0.99.9000      Rcpp_1.0.9            
#>  [45] slam_0.1-50            Biobase_2.58.0        
#>  [47] jquerylib_0.1.4        vctrs_0.5.1           
#>  [49] Biostrings_2.66.0      nlme_3.1-161          
#>  [51] ape_5.6-2              xfun_0.36             
#>  [53] stringr_1.5.0          mime_0.12             
#>  [55] lifecycle_1.0.3        pvclust_2.2-0         
#>  [57] XML_3.99-0.13          dendextend_1.16.0     
#>  [59] org.Hs.eg.db_3.16.0    zlibbioc_1.44.0       
#>  [61] MASS_7.3-58.1          scales_1.2.1          
#>  [63] tidygraph_1.2.2        promises_1.2.0.1      
#>  [65] parallel_4.2.2         cyjShiny_1.0.34       
#>  [67] yaml_2.3.6             memoise_2.0.1         
#>  [69] gridExtra_2.3          yulab.utils_0.0.6     
#>  [71] sass_0.4.4             stringi_1.7.12        
#>  [73] RSQLite_2.2.20         highr_0.10            
#>  [75] S4Vectors_0.36.1       BiocGenerics_0.44.0   
#>  [77] GenomeInfoDb_1.34.6    rlang_1.0.6           
#>  [79] pkgconfig_2.0.3        bitops_1.0-7          
#>  [81] lattice_0.20-45        evaluate_0.19         
#>  [83] purrr_1.0.1            patchwork_1.1.2       
#>  [85] htmlwidgets_1.6.1      cowplot_1.1.1         
#>  [87] bit_4.0.5              tidyselect_1.2.0      
#>  [89] magrittr_2.0.3         bookdown_0.31         
...
#> [101] wordcloud_2.6          utf8_1.2.2            
#> [103] rmarkdown_2.19         viridis_0.6.2         
#> [105] GetoptLong_1.0.5       grid_4.2.2            
#> [107] blob_1.2.3             digest_0.6.31         
#> [109] xtable_1.8-4           tm_0.7-10             
#> [111] tidyr_1.2.1            httpuv_1.6.8          
