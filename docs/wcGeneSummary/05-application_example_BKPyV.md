...
#>  [45] scales_1.2.0           DOSE_3.22.0           
#>  [47] DBI_1.1.3              Rcpp_1.0.9            
#>  [49] viridisLite_0.4.0      xtable_1.8-4          
#>  [51] tidytree_0.3.9         gridGraphics_0.5-1    
#>  [53] reactome.db_1.81.0     bit_4.0.4             
...
#>  [93] aplot_0.1.6            DO.db_2.9             
#>  [95] xml2_1.3.3             compiler_4.2.1        
#>  [97] rstudioapi_0.13        png_0.1-7             
#>  [99] treeio_1.20.1          tibble_3.1.7          
#> [101] tweenr_1.0.2           bslib_0.4.0           
#> [103] stringi_1.7.8          cyjShiny_1.0.34       
...
#> [129] ggfun_0.0.9            grid_4.2.1            
#> [131] tidyr_1.2.0            rmarkdown_2.14        
#> [133] downlit_0.4.2          NLP_0.2-1             
#> [135] shiny_1.7.2            base64enc_0.1-3
```
